...
export const DCSModCard = ({ mod }) => {
    return (
        <li className={styles.modCard}>
            ...
            <div className={styles.info}><a href={mod.fields.Info} target="_blank" ><FontAwesomeIcon icon={faCircleInfo}/></a></div>
            <div className={styles.cardBody}>
                ...
                <div className={styles.downloadButton}><a href={mod.fields.URL} target="_blank" >Download</a></div>
            </div>
        </li>
    );
}   